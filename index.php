...
<header class="main-header">
    ...
    <div class="main-header__container">
        <!-- <a href="login.html" class="product-btn"><em class="fas fa-user"></em></a>
        <a href="" class="product-btn"><em class="fas fa-shopping-cart"></em></a> -->
...
<body>
    <div class="main" style="padding-bottom: 0px;">
        <div class="container">
            <h2 class="main-title">NUESTROS VINOS MAS VENDIDOS </h2>
    ...
    <div class="flotante">
        <input type="checkbox"><em class="fas fa-shopping-cart" id="btn-carrito"></em></imput>
    </div>
