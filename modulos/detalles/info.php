...
$ruta = __DIR__ . "/cURL/auth.php?cerrar_sesion=$cerrar_sesion";
...
$productoEncontrado = $curl->get(tabla: "vinos", parametros: "id_unica=eq.$productoID&select=id,nombre,anada,bodega,region,precio,stock,tipo,nivel_alcohol,tipo_barrica,descripcion,notas_cata,temperatura_consumo,activo,id_unica,url_imagen,promocion,busqueda,maridaje,pais,paises(pais),id_categoria,secciones(nombre),variedad,variedades(variedad)")[0];
